...
![img](D:\有道云文件\software_hb@163.com\4fe27f2d69474b03b64c05b25edd76be\q5ho684jmh.png)

**表达公式**

![img](D:\有道云文件\software_hb@163.com\c51113fdb905406780eb0c44cce3304b\vkvfw@pcxccj.png)
...
def xyplot(x_vals, y_vals, name):    # d2l.set_figsize(figsize=( )    plt.plot(x_vals.detach().numpy(), y_vals.detach().numpy())    plt.xlabel('x')    plt.ylabel(name + '(x)')

In [7]:

x = torch.arange(-8.0, 8.0, 0.1, requires_grad=True) y = x.relu() xyplot(x, y, 'relu')

![img](D:\有道云文件\software_hb@163.com\6e65647ecfc54f92b569e45ff9880739\q5hv7cdtna.png)

In [8]:

y.sum().backward() xyplot(x, x.grad, 'grad of relu')

![img](D:\有道云文件\software_hb@163.com\7961f8a891eb42fe920c748b2b461ce7\q5hv7c3pxb.png)

**Sigmoid函数**

sigmoid函数可以将元素的值变换到0和1之间：

![img](D:\有道云文件\software_hb@163.com\9dc1a6fe937c4cd5af5707e2ea809b64\09bb5be7b17846658c625ab5ec8b3330.jpg)

In [9]:

y = x.sigmoid() xyplot(x, y, 'sigmoid')

![img](D:\有道云文件\software_hb@163.com\81ee4c834f974d469e1c1c848e5ee1e6\q5hv7dor11.png)

依据链式法则，sigmoid函数的导数

![img](D:\有道云文件\software_hb@163.com\33d1bb51722245c9ab76b32888c1b2b7\f630ea3c6382460cb5aecbf6016b3848.jpg)
...
![img](D:\有道云文件\software_hb@163.com\ec722a2e7050404f985e0a5c6028c3ae\q5hv7dpse9.png)

**tanh函数**

tanh（双曲正切）函数可以将元素的值变换到-1和1之间：

![img](D:\有道云文件\software_hb@163.com\6f05321d60a5417cb6b480359722b1e6\bcca5909826043bb97499b3bfeb1f7a3.jpg)
...
![img](D:\有道云文件\software_hb@163.com\0e332da5cab6485c8f18ee61c7fd9911\q5hv7dfeso.png)

依据链式法则，tanh函数的导数

![img](D:\有道云文件\software_hb@163.com\5d63fda371104e48a52745b9d4b0edf1\48b1b547ea4649f194e6fca25ded766c.jpg)
...
![img](D:\有道云文件\software_hb@163.com\5fb3cdd41c51484daa3c99f3e777d7b6\q5hv7ejc8y.png)
...
![img](D:\有道云文件\software_hb@163.com\5b00378b68b74274a7b8ec5912e972a6\5c555165877e40d2a196905834ab6a90.jpg)
...
为什么reLU函数没有梯度消失的问题？https://www.boyuai.com/elites/course/cZu18YmweLv10OeV/video/yHXvo1xsl5_q5KLVj8pYK#comment-s44k1lmHtEqMts9sTTA1o

https://www.boyuai.com/elites/course/cZu18YmweLv10OeV/video/yHXvo1xsl5_q5KLVj8pYK#comment-kquESmSqlrBWqhJklqplm
